...
// modal 
const open_sapporo = document.getElementById('sapporo-circle');
...
const open_tokyo = document.getElementById('tokyo-circle');
...
const open_kitakata = document.getElementById('kitakata-circle');
...
const open_hakata = document.getElementById('hakata-circle');
